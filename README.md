...
1. **Clone the repository**:
   ```bash
   git clone git@github.com:JupyterJones/QuickZoom.git


QuickZoom is a small Flask application that allows you to quickly zoom into an image and save the zoom animation as an MP4. The app also enables you to add a customizable music background and a frame to the video. It has been tested on Linux systems.
Features:
